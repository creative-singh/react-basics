      ...
      <main className="max-w-5xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="mb-8">
            ...
            <ul className="mt-4 space-y-2 text-gray-700 list-disc list-inside">
              <li>Maintained client books and ledgers using Tally ERP software.</li>
              <li>Finalized monthly and annual financial statements—Balance Sheets, P&L, and cash flow with applicable accounting standards.</li>
              <li>Filed ROC forms AOC-4, MGT-7 for statutory compliance.</li>
